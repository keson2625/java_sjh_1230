...
public class Ex10_Homewokr {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 메뉴 1. UpDown 게임 실행 2. 최고 기록 확인 3. 프로그램 종료 메뉴 선택 : 2 게임을 실행 한적이 없습니다. 메뉴 1.
		 * UpDown 게임 실행 2. 최고 기록 확인 3. 프로그램 종료 메뉴 선택 : 1 입력 : 50 Down! 입력 : 25 정답! 메뉴 1.
		 * UpDown 게임 실행 2. 최고 기록 확인 3. 프로그램 종료 메뉴 선택 : 2 2회 메뉴로 가려면 엔터를 입력하세요. 메뉴 1.
		 * UpDown 게임 실행 2. 최고 기록 확인 3. 프로그램 종료 메뉴 선택 : 프로그램 종료합니다.
		 */
